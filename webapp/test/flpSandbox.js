		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#TestMasterDetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TestMasterDetail-display": {
								"semanticObject": "TestMasterDetail",
								"action": "display",
								"description": "Test Master Detail",
								"title": "Test Master Detail",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=md.app.MasterDetail",
									"url": sap.ui.require.toUrl("md/app/MasterDetail")
								}
							}
						}
					}
